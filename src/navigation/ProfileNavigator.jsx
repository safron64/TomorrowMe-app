			...
			<Container>
				...
				<InfoContainer>
					...
					<InfoItem>
						...
						<Value>{user.company_or_school_name || 'Не указано'}</Value>
					</InfoItem>
					<InfoItem>
						<Label>Должность или область обучения:</Label>
						<Value>{user.position_or_field_of_study || 'Не указано'}</Value>
					</InfoItem>
					<InfoItem>
						<Label>Лет на работе или учебе:</Label>
						<Value>{user.years_at_job_or_study || 'Не указано'}</Value>
					</InfoItem>
					<InfoItem>
						<Label>Замечания о стабильности эмоций:</Label>
						<Value>{user.emotional_stability_notes || 'Не указано'}</Value>
					</InfoItem>
					<InfoItem>
						<Label>Стиль общения:</Label>
						<Value>{user.communication_style || 'Не указано'}</Value>
					</InfoItem>
					<InfoItem>
						...
						<ModalContent>
							...
							<ScrollView>
								...
								<InputContainer>
									...
									<Input
										value={editData.age ? editData.age.toString() : ''}
										onChangeText={text =>
											setEditData({
												...editData,
												age: parseInt(text),
								...
								<InputContainer>
									<LabelInput>Компания или учебное заведение:</LabelInput>
									<Input
										value={editData.company_or_school_name || ''}
										onChangeText={text =>
											setEditData({
												...editData,
								...
								<InputContainer>
									<LabelInput>Должность или область обучения:</LabelInput>
									<Input
										value={editData.position_or_field_of_study || ''}
										onChangeText={text =>
											setEditData({
												...editData,
												position_or_field_of_study: text,
											})
										}
								...
								<InputContainer>
									<LabelInput>Лет на работе или учебе:</LabelInput>
									<Input
										value={editData.years_at_job_or_study ? editData.years_at_job_or_study.toString() : ''}
										onChangeText={text =>
											setEditData({
												...editData,
												years_at_job_or_study: parseInt(text),
											})
										}
								...
								<InputContainer>
									<LabelInput>Замечания о стабильности эмоций:</LabelInput>
									<Input
										value={editData.emotional_stability_notes || ''}
										onChangeText={text =>
											setEditData({
												...editData,
								...
								<InputContainer>
									...
									<Input
										value={editData.communication_style || ''}
										onChangeText={text =>
											setEditData({
												...editData,
								...
								<InputContainer>
									<LabelInput>Дополнительные заметки:</LabelInput>
									<Input
								...
								<InputContainer>
									<LabelInput>Пользовательское поле:</LabelInput>
									<Input
